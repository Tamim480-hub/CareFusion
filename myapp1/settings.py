...
SECRET_KEY = 'django-insecure-6+w3%!-s0#wpz(domcff2p5441w_q5v^#kx33-91soj-b5yy0+'
...
MIDDLEWARE = [
    ...
    'myapp.middleware.HospitalMiddleware',
]
...
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # ← শুধু এটি রাখো
]
...
# ALLOWED_HOSTS সেকশন খুঁজুন এবং এডিট করুন:

ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'testserver',  # ← এটা যোগ করুন (টেস্টের জন্য জরুরি!)
]
